...
lemma (in Contract)
  ...
  (*Aliasing*)
  apply (drule_tac ?is3.0 = "[Uint (word_of_nat j)]" and ?l1.0=la in aliasing_1, simp, simp)
  apply mc+
...
lemma (in Contract)
  ...
  (*Aliasing*)
  apply (drule_tac ?is1.0 = "[Uint (word_of_nat i), Uint (word_of_nat k)]" and ?is3.0 = "[Uint (word_of_nat i)]" in aliasing_2, simp, simp)
  apply mc+
  using dlookup_array2[OF assms(2,4)] apply auto[1]
  apply mc+
  using dlookup_array2[OF assms(2,4)] apply auto[1]
...
lemma (in Contract)
  ...
  apply (drule_tac ?is3.0 = "[Uint (word_of_nat j)]" and ?l1.0=la and ?l2.0=x1 in aliasing_1, simp, simp)
  apply (mc lookup: dlookup_array3[OF assms(2,5)] dlookup_array3[OF assms(1,4)])+

  apply (drule_tac ?is3.0 = "[Uint (word_of_nat l), Uint (word_of_nat m)]" and ?l1.0=laa and ?l2.0=x1 in aliasing_1, simp, simp)
