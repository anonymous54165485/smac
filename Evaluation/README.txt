This folder contains memory array tests and corresponding results for Certora, solc-verify, solCMC, and SMAC (Table 1 in the paper). 

	1- There are four sub-folders: Certora, solc-verify, solCMC, and SMAC.
